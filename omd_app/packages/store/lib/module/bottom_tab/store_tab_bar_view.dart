...
class StoreTabBarView extends GetView<StoreBottomNavLogic> {
  const StoreTabBarView({super.key});
    ...
    return Obx(() {
      return Container(
        ...
        decoration: const BoxDecoration(
          color: StoreColors.tabBarBackground,
          border: Border(top: BorderSide(color: StoreColors.tabBarBorder)),
          boxShadow: [
            BoxShadow(
...
class _StoreTabItem extends StatelessWidget {
  const _StoreTabItem({
  ...
  Widget build(BuildContext context) {
    final color =
        isActive ? StoreColors.tabSelected : StoreColors.tabUnselected;
    return Material(
