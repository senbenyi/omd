...
/// 自动生成 common 插件中的 assets 静态变量。
/// 扫描 assets/images 目录下所有文件，生成 lib/gen/assets.dart。
//运行命令
...
/// 自动生成 common 插件中的 assets 静态变量（驼峰命名，不含文件夹名）
/// 扫描 assets 目录下所有文件，生成 lib/gen/assets.dart。
void main() {
  const packageName = 'common'; // ⚠️ 插件包名
  const assetsDir = 'assets';
  const outputFile = 'lib/gen/assets.dart';
